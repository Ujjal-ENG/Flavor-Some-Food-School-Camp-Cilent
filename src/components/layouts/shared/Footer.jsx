            ...
            <section className="py-10 bg-gray-900 sm:pt-16 lg:pt-24">
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div className="grid grid-cols-2 gap-x-5 gap-y-12 md:grid-cols-4 md:gap-x-12">
                        <div>
                            ...
                            <ul className="mt-8 space-y-4">
                                <li>
                                    <a href="#" title="" className="text-base text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80">
                                        {' '}
                                        About{' '}
                                    </a>
                                </li>
                    ...
                    <div className="flex flex-wrap items-center justify-between">
                        <div className="order-1 md:h-28 h-full">
                        ...
                        <p className="w-full mt-8 text-sm text-center text-gray-100 md:mt-0 md:w-auto md:order-2">© Copyright 2021, All Rights Reserved by Flavorsome|Food School</p>
                    </div>
                </div>
            </section>
        </div>
