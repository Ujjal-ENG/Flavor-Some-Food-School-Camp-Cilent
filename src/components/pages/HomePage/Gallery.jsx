            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto flex flex-wrap">
                    <div className="flex w-full mb-20 flex-wrap">
                        <h1 className="sm:text-4xl text-2xl font-medium title-font text-gray-900 lg:w-1/3 lg:mb-0 mb-4">Master Cleanse Reliac Heirloom</h1>
                                    ...
                                    <div className="absolute inset-0 bg-gray-900 bg-opacity-0 group-hover:bg-opacity-70 transition-opacity duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
                                        <div className="px-10 text-center">
                                            ...
                                            <p className="text-xl tracking-wider text-white">
                                                Master the art of baking as campers create delectable desserts, pastries, bread, and other sweet treats under the guidance of our skilled pastry chefs.
                                            </p>
                                            <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                                                <a className="text-white text-3xl py-3">
                                                    <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                                                        <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" />
                                                    </svg>
                                                </a>
                                                <a className="ml-3 text-white text-3xl py-3">
                                                    <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                                ...
                                <div className="group relative w-full h-full">
                                    ...
                                    <div className="absolute inset-0 bg-gray-900 bg-opacity-0 group-hover:bg-opacity-70 transition-opacity duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
                                        <div className="px-10 text-center">
                                            ...
                                            <p className="text-xl tracking-wider text-white">
                                                We maintain a clean and well-equipped kitchen facility, ensuring that all participants adhere to proper food handling practices and sanitation
                                                guidelines.
                                            </p>
                                            <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                                                <a className="text-white text-3xl py-3">
                                ...
                                <div className="group relative w-full h-full">
                                    ...
                                    <div className="absolute inset-0 bg-gray-900 bg-opacity-0 group-hover:bg-opacity-70 transition-opacity duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
                                        <div className="px-10 text-center">
                                            ...
                                            <p className="text-xl tracking-wider text-white">
                                                Our Summer Food Camp not only focuses on cooking skills but also emphasizes teamwork, creativity, and problem-solving. Campers will collaborate with
                                                their peers, work in groups to prepare meals, and present their culinary creations. They will also participate in fun challenges, friendly competitions,
                                                and food-themed games, fostering a sense of camaraderie and fostering a love for the culinary arts.
                                            </p>
                                            <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                                                <a className="text-white text-3xl py-3">
                                                    <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                                ...
                                <div className="group relative w-full h-full hover:shadow-xl">
                                    ...
                                    <div className="absolute inset-0 bg-gray-900 bg-opacity-0 group-hover:bg-opacity-70 transition-opacity duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
                                        <div className="flex justify-center items-center flex-col px-20">
                                            ...
                                            <p className="text-xl tracking-wider text-white">
                                                Delve into the diverse cuisines of various countries, such as Italian pasta making, Mexican taco fiestas, Japanese sushi rolling, and more. During the
                                                camp, participants will have the opportunity to sharpen their culinary skills, discover new ingredients, and develop a deeper understanding of food
                                                preparation techniques. Our experienced chefs and culinary experts will guide campers through hands-on cooking lessons, interactive workshops, and
                                ...
                                <div className="group relative w-full h-full">
                                    ...
                                    <div className="absolute inset-0 bg-gray-900 bg-opacity-0 group-hover:bg-opacity-70 transition-opacity duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
                                        <div className="px-10">
                                            ...
                                            <p className="text-xl tracking-wider text-white">
                                                Learn about the importance of fresh, locally-sourced ingredients and how to create delicious, healthy meals using seasonal produce.
                                            </p>
                                            <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                                                <a className="text-white text-3xl py-3">
                                                    <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                                ...
                                <div className="group relative w-full h-full">
                                    ...
                                    <div className="absolute inset-0 bg-gray-900 bg-opacity-0 group-hover:bg-opacity-70 transition-opacity duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
                                        <div className="px-10">
                                            ...
                                            <p className="text-xl tracking-wider text-white">
                                                Dive into the science behind cooking, understanding the nutritional value of ingredients, and exploring the impact of food on our health.
                                            </p>
                                            <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                                                <a className="text-white text-3xl py-3">
                                                    <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
