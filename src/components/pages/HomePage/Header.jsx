...
const Header = () => {
    return (
        <div>
            <div className="bg-white h-[110vh] pt-24">
                <section className="bg-[#FCF8F1] bg-opacity-30 py-10 sm:py-16 lg:py-24">
                    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                        <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                            <div>
                                <p className="text-base font-semibold tracking-wider text-blue-600 uppercase">A Summer Camp Food School for learners</p>
                                ...
                                <Link
                                    ...
                                    role="button">
                                    Join for free
                                    <svg className="w-6 h-6 ml-8 -mr-2 animate-pulse" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
